...
// const char *sensorIp = "192.168.12.2"; // Replace with your sensor's IP
...
// const char* udpAddress = "192.168.12.2"; // Replace with your server's IP address
...
//   int pos = 18;
//   float Fx = (float) (parseInteger( buffer, pos+0 ));
//   float Fy = (float)(parseInteger(buffer, pos + 4));
//   float Fz = (float)(parseInteger(buffer, pos + 8));
//   float Tx = (float)(parseInteger(buffer, pos + 12));
//   float Ty = (float)(parseInteger(buffer, pos + 16));
//   float Tz = (float)(parseInteger(buffer, pos + 20));

//   int z_result = (-0.00072963*Fx + 0.00071161*Fy + (-0.00083128)*Fz + 0.00166689*Tx + (-0.00059223) * Ty + 0.00035427*Tz) - 26.4;
//     // Serial.print(Fx);
//     // Serial.print("    ");
//     // Serial.print(Fy);
//     // Serial.print("    ");
...
void loop() {
  ...
  //   int dataToSend = readDataPacket(); // Example data
